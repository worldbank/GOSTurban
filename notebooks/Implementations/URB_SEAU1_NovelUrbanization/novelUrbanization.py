...
class urban_data(object):
    ...
    def jaccard_index(self, pop_type='gpo', res='', 
                        dou_urb = "_urban.tif", dou_hd = "_hd.tif", 
                        db_urb = "_ur.tif", db_hd = "_co.tif"):
...
EA_DEFS = { # Define ea files per iso3
    ...
    "MRT": ["/home/wb411133/data/Projects/MR_Novel_Urbanization/Data/EA_Files/Mauritania", "MAU_edit.shp", "mauritania.geojson"],
    ...
    "UGA": ["/home/wb411133/data/Projects/MR_Novel_Urbanization/Data/EA_Files/Uganda/GeoBoundaries", "geoBoundaries-UGA-ADM2.shp", ""],
